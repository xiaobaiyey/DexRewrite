...
// Classes to access Dex data.
    ...
    public:
        ...
        base::IterationRange<DataIterator<Field>> GetFields() const;

        // Return the iteration range for all the static fields.
        base::IterationRange<DataIterator<Field>> GetStaticFields() const;

        // Return the iteration range for all the instance fields.
        base::IterationRange<DataIterator<Field>> GetInstanceFields() const;

        // Return the iteration range for all the methods.
        base::IterationRange<DataIterator<Method>> GetMethods() const;

        // Return the iteration range for the direct methods.
        base::IterationRange<DataIterator<Method>> GetDirectMethods() const;

        // Return the iteration range for the virtual methods.
        base::IterationRange<DataIterator<Method>> GetVirtualMethods() const;
    ...
    protected:
        ...
        base::IterationRange<DataIterator<Field>> GetFieldsInternal(size_t count) const;

        // Return an iteration range for the first <count> methods.
        base::IterationRange<DataIterator<Method>> GetMethodsInternal(size_t count) const;
