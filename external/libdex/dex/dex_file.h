...
#include "hiddenapi_domain.h"
#include "libbase/macros.h"
#include "libbase/value_object.h"
...
/*        // Given a signature place the type ids into the given vector, returns true on success
        ...
        const T *DataPointer(size_t offset) const {
            CHECK_LT(offset, DataSize()) << "Offset past end of data section";
        ...
        base::IterationRange<ClassIterator> GetClasses() const;
