#ifndef waa_BASE_BIT_UTILS_H_
#define waa_BASE_BIT_UTILS_H_
...
#define DCHECK_ALIGNED(value, alignment) \
  DCHECK(::IsAligned<alignment>(value)) << reinterpret_cast<const void*>(value)

#define CHECK_ALIGNED_PARAM(value, alignment) \
  CHECK(::IsAlignedParam(value, alignment)) << reinterpret_cast<const void*>(value)

#define DCHECK_ALIGNED_PARAM(value, alignment) \
  DCHECK(::IsAlignedParam(value, alignment)) << reinterpret_cast<const void*>(value)
